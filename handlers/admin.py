...
async def send_photo_news1(message: Message, state: FSMContext):
    ...
    await asyncio.gather(*map(send_notification(what_send, text, photo), all_teachers_ids))
...
def register_handler_admin(dp: Dispatcher):
    ...
    dp.register_message_handler(send_photo_news1, content_types=["photo", "text"], state=FSMAdmin.photo)
    # ===========================Викласти текст=============================
    ...
    dp.register_message_handler(send_mixed_news2, content_types=["photo", "text"], state=FSMAdmin.mixed_photo)
    # ===========================Видалити акаунт=============================
